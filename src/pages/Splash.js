  ...
  return (
    <div className="splash-container relative">
      ...
      <div className="relative w-full h-[55vh] bg-cover bg-center" style={{ backgroundImage: 'url(/uyuni.avif)' }}>
        <div className="absolute w-full" style={{ top: '30vh' }}>
          <div className="grid grid-cols-12 gap-x-5">
            <div className="col-start-2 col-span-10">
              <h1 className="md:text-[4vw] lg:text-[6vh] font-merriweather text-splash-title-gray-blue leading-tight">
        ...
        <figcaption className="absolute lg:text-[2vh] md:text[1vh] right-0 bottom-0 bg-white bg-opacity-70 text-gray-800 p-1">
      ...
      <div className="grid grid-cols-3 mx-5 gap-5 h-[35vh]">
        <div className="discover-more flex flex-col justify-center items-center border-4 border-slate-200 rounded-3xl space-y-[1vh] my-[1vh] p-[1vh] max-h-[35vh]">
          <svg
            viewBox="0 0 512 512"
            fill="#3B6EA5"
          ...
          <p className="lg:text-[5vh] md:text-[4vh] font-poppins">Discover More</p>
          <p className="lg:text-[2vh] md:text-[1vh] font-roboto text-center">
            Find your perfect destination. Our platform aligns with your preferences for an ideal vacation.
          </p>
        </div>
        <div className="smart-insights flex flex-col justify-center items-center border-4 border-slate-200 rounded-3xl space-y-[1vh] my-[1vh] p-[1vh] max-h-[35vh]">
          ...
          <p className="lg:text-[5vh] md:text-[4vh] font-poppins">Smart Insights</p>
          <p className="lg:text-[2vh] md:text-[1vh] font-roboto text-center">
            Get the scoop on your next destination with AI-driven tips and local knowledge.
          </p>
        </div>
        <div className="store flex flex-col justify-center items-center border-4 border-slate-200 rounded-3xl space-y-[1vh] my-[1vh] p-[1vh] max-h-[35vh]">
          ...
          <p className="lg:text-[5vh] md:text-[4vh] font-poppins">Your Travel, Curated</p>
          <p className="lg:text-[2vh] md:text-[1vh] font-roboto text-center">
